...
$(document).ready(function() {
    ...
    // aggancio funzione click a bottone
    $('#aggiungi-vendita').click(function() {
        ...
        $.ajax({
            ...
            'data':{
                ...
                // lo metterà come stringa per quello fareme il parseInt quando lo leggeremo
            },
            'success': function() {
                disegna_grafici();
            },
    ...
    function prepara_dati_vendite_mensili(dati) {
        ...
        for (var i = 0; i < dati.length; i++) {
            ...
            var importo_vendita_corrente = parseInt(vendita_corrente.amount);
